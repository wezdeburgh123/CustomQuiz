...
|---|---|
| Norsk historie (`historie`) | 9 |
| Verdenshistorie (`verdenshistorie`) | 9 |
| Vitenskap og natur (`vitenskap`) | 9 |
| Geografi (`geografi`) | 9 |
| Litteratur (`litteratur`) | 9 |
| Kunst (`kunst`) | 9 |
| Film (`film`) | 9 |
| Musikk (`musikk`) | 9 |
| Sport (`sport`) | 45 |
...
## Underemner per kategori (i køen)

### Norsk historie
Vikingtiden, Slaget på Stiklestad, Harald Hårfagre og rikssamlingen

### Verdenshistorie
Det gamle Egypt, Romerriket, Antikkens Hellas

### Vitenskap og natur
Solsystemet, Det periodiske system, Evolusjon og Darwin

### Geografi
Norges fylker og byer, Europas hovedsteder, Verdens hovedsteder

### Litteratur
Henrik Ibsen, Bjørnstjerne Bjørnson, Knut Hamsun

### Kunst
Renessansekunst, Leonardo da Vinci, Michelangelo
