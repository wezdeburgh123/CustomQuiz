...
# -*- coding: utf-8 -*-
"""
Slår rebus-serien (1 quiz: byer-i-norge-rebus__lett) inn i arkivet TRYGT og
idempotent. Kjør fra prosjektmappa:  python3 quiz-library/merge-rebus-serie.py
...
SRC      = os.path.join(HERE, "rebus-serie-KLAR-FOR-ARKIV.ndjson")
...
def main():
    ...
    if os.path.exists(LIBRARY):
        ...
        bak = LIBRARY + ".bak-pre-rebus-" + stamp
