...
# -*- coding: utf-8 -*-
"""
Slår innholds-bølgen 11.8 (2 quizer: gresk-mytologi__vanskelig + fysikk) inn i arkivet TRYGT og
idempotent. Kjør fra prosjektmappa:  python3 quiz-library/merge-innhold-11aug.py
...
SRC      = os.path.join(HERE, "innhold-11aug-KLAR-FOR-ARKIV.ndjson")
...
def main():
    ...
    if os.path.exists(LIBRARY):
        ...
        bak = LIBRARY + ".bak-pre-innhold11aug-" + stamp
