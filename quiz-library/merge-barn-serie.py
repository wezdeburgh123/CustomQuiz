...
# -*- coding: utf-8 -*-
"""
Slår barne-dyreserien inn i arkivet TRYGT og idempotent.
Kjør fra prosjektmappa:  python3 quiz-library/merge-barn-serie.py

Gjør to ting i samme operasjon (viktig — ellers kan nattskiftet lage
dubletter): legger de 6 quizene i library.ndjson OG registrerer de 6
emnene i topics.json. Kan kjøres flere ganger uten å lage dubletter.
"""
import json, os, sys

HERE = os.path.dirname(os.path.abspath(__file__))
SRC      = os.path.join(HERE, "barn-dyr-serie-KLAR-FOR-ARKIV.ndjson")
