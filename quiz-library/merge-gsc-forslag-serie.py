...
# -*- coding: utf-8 -*-
"""
Slår GSC-forslag-serien (10 quizer) inn i arkivet TRYGT og idempotent.
Kjør fra prosjektmappa:  python3 quiz-library/merge-gsc-forslag-serie.py
...
SRC      = os.path.join(HERE, "gsc-forslag-serie-KLAR-FOR-ARKIV.ndjson")
...
def main():
    ...
    # indent=1 for å matche repoets eksisterende formattering (nattskiftet skriver
    # med 1-mellomrom) — gir minimal, konfliktfri git-diff.
